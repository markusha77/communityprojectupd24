    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex space-x-4 mb-12">
          <button 
            className={`flex items-center px-4 py-2 ${liked ? 'bg-red-50 text-red-600 border border-red-200' : 'bg-white border border-gray-300 text-gray-700'} rounded-md shadow-sm text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
            onClick={handleLike}
          >
        ...
        {/* Comments section */}
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-4">Comments ({project.comments})</h2>
                ...
                <div className="border border-gray-300 rounded-lg overflow-hidden focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
                  ...
                  <div className="py-2 px-4 bg-gray-50 flex justify-between items-center">
                    <div className="flex space-x-1">
                      <button type="button" className="p-1 rounded text-gray-500 hover:text-gray-600">
          ...
          <div className="space-y-6">
            {mockComments.map((comment) => (
              <div key={comment.id} className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
